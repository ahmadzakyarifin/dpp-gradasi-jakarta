...
## Corpus Check
- 179 files · ~115,858 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1068 nodes · 2167 edges · 69 communities (50 shown, 19 thin omitted)
...
Cohesion: 0.08
Nodes (23): GetAuditMeta(), Context, ErrorResponse(), Context, SuccessResponse(), ValidationErrorResponse(), Context, mapServiceError() (+15 more)
...
Cohesion: 0.09
Nodes (18): GenerateValidationMessage(), GetPaginationMeta(), IsValidEmail(), IsValidURL(), RateLimitResponse(), NewSettingsHandler(), DB, NewSettingsRepo() (+10 more)
...
Cohesion: 0.06
Nodes (32): GenerateAccessToken(), GenerateRefreshToken(), RegisteredClaims, Time, ValidateToken(), CheckPassword(), HashPassword(), GenerateActivationToken() (+24 more)
...
Cohesion: 0.05
Nodes (34): NewServiceError(), Context, VerifyTurnstile(), GetUserID(), Context, BulkRequest, NewSlidersService(), toResponse() (+26 more)
...
### Community 21 - "NewApp"
Cohesion: 0.16
Nodes (10): App, Client, DB, NewApp(), Client, registerRoutes(), NewKegiatanHandler(), NewKontakHandler() (+2 more)
...
### Community 33 - "ActivityLogHandler"
Cohesion: 0.23
Nodes (6): Context, NewActivityLogHandler(), validationMessage(), Errors(), ActivityLogHandler, ValidationErrorItem

### Community 50 - "main"
Cohesion: 0.18
Nodes (7): main(), main(), ConnectDB(), DB, ConnectRedis(), Client, RegisterValidator()

### Community 63 - "ActivityLogService"
Cohesion: 0.18
Nodes (9): ActivityLogService, NewAuthHandler(), NewDashboardHandler(), DB, NewDashboardService(), NewPengurusHandler(), NewSlidersHandler(), DashboardHandler (+1 more)
...
## Knowledge Gaps
- **101 isolated node(s):** `github.com/ahmadzakyarifin/dpp-gradasi/backend`, `contextKey`, `Response`, `TurnstileVerifyResult`, `RegisterRequest` (+96 more)
...
- **Why does `NewApp()` connect `NewApp` to `ErrorResponse`, `ActivityLogHandler`, `KegiatanRepo`, `activityLogRepository`, `AuthRepo`, `BeritaRepo`, `response.go`, `PengurusService`, `SlidersRepo`, `KontakRepo`, `Config`, `RateLimiter`, `AuthService`, `NewServiceError`, `main`, `ActivityLogService`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `NewServiceError()` connect `NewServiceError` to `ErrorResponse`, `KegiatanRepo`, `BeritaRepo`, `PengurusService`, `KontakRepo`, `AuthService`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `ErrorResponse()` connect `ErrorResponse` to `ActivityLogHandler`, `response.go`, `Rule`, `RoleMiddleware`, `AuthMiddleware`, `NewServiceError`?**
