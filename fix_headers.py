...
target = r'<div class="flex items-center gap-4">\s*<div class="flex items-center gap-2">\s*<img src="https://ui-avatars\.com/api/\?name=[^"]+" class="w-8 h-8 rounded-full" alt="Admin">\s*<span class="text-sm font-medium text-gray-700">[^<]+</span>\s*</div>\s*</div>'
