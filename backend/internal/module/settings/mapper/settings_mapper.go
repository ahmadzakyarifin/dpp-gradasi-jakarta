...
func ModelToEntity(m *model.Settings) *entity.Settings {
	...
	return &entity.Settings{
		...
		GreetingSignName:   m.GreetingSignName,
		GreetingSignSubtitle: m.GreetingSignSubtitle,
		GreetingSignImage1:   m.GreetingSignImage1,
		GreetingSignImage2:   m.GreetingSignImage2,
...
func EntityToResponse(e *entity.Settings) *dto.SettingsResponse {
	...
	return &dto.SettingsResponse{
		...
		GreetingSignName:   e.GreetingSignName,
		GreetingSignSubtitle: e.GreetingSignSubtitle,
		GreetingSignImage1:   e.GreetingSignImage1,
		GreetingSignImage2:   e.GreetingSignImage2,
