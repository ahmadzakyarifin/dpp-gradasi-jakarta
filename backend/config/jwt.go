...
type JWTConfig struct {
	...
	Issuer                    string `env:"JWT_ISSUER" envDefault:"dpp-gradasi"`
	Audience                  string `env:"JWT_AUDIENCE" envDefault:"dpp-gradasi-web"`
	PasswordResetTTLMinutes   int    `env:"PASSWORD_RESET_TTL_MINS" envDefault:"15"`
	AccountActivationTTLHours int    `env:"ACCOUNT_ACTIVATION_TTL_HOURS" envDefault:"24"`
}
