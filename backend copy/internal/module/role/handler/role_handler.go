...
import (
	...
	"github.com/ahmadzakyarifin/schoolpay/backend/internal/module/role/dto"
	"github.com/ahmadzakyarifin/schoolpay/backend/internal/module/role/mapper"
	"github.com/ahmadzakyarifin/schoolpay/backend/internal/module/role/service"
...
func (h *RoleHandler) CheckUnique(c *gin.Context) {
	...
	if field == "" || value == "" {
		helper.ErrorResponse(c, http.StatusBadRequest, "VALIDATION_ERROR", "field dan value harus diisi", nil)
		return
	}
