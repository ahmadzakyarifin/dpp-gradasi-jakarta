...
type Settings struct {
	...
	GreetingSignName     string `gorm:"size:255"`
	GreetingSignSubtitle string `gorm:"size:255"`
	GreetingSignImage1   string `gorm:"size:500"`
	GreetingSignImage2   string `gorm:"size:500"`
